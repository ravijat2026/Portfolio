...
const Experience = () => {
  ...
  return (
      ...
      <div name = "Experience" className="p-5 mx-20 mb-10 max-sm:p-2 max-sm:mx-5">
        ...
        <div
          className="flex gap-7 justify-center flex-row max-sm:flex-col"
          data-aos="fade-right"
        >
          <div className="max-w-[720px] mt-6 p-7 max-sm:p-3">
